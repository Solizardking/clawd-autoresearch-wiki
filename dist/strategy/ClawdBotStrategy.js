import { latestRSI, calculateRSI, emaCrossState, calculateATR, } from './indicators.js';
export class ClawdBotStrategy {
        ...
        const fundingBias = fundingRate === null
            ...
            : fundingRate > p.fundingRateThreshold
                ...
                : fundingRate < -p.fundingRateThreshold
                    ...
                    : 'neutral';
        const priceVsEmaFast = emaCross.ema_fast === null
            ? 'at'
    ...
    // ── Private helpers ────────────────────────────────────────────────────────
    filteredSignal(currentPrice, opts) {
...
//# sourceMappingURL=ClawdBotStrategy.js.map